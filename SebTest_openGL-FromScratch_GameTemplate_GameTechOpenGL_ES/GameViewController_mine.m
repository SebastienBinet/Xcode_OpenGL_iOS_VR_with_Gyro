...
GLfloat gCubeVertexData[36*6] =
{
    // Data layout for each line below is:
    // positionX, positionY, positionZ,     normalX, normalY, normalZ,
    0.5f, -0.5f, -0.5f,        2.5f, -0.5f, -0.5f,
    0.5f, 0.5f, -0.5f,         2.5f, 0.5f, -0.5f,
    0.5f, -0.5f, 0.5f,         2.5f, -0.5f, 0.5f
    ,
...
//    _rotationCube = 0.0f;
//    _rotationViewer = 0.0f;
    float aspect = fabs(self.view.bounds.size.width / self.view.bounds.size.height);
    GLKMatrix4 projectionMatrix = GLKMatrix4MakePerspective(GLKMathDegreesToRadians(65.0f), aspect, 0.1f, 100.0f);
    
//    self.effect.transform.projectionMatrix = projectionMatrix;
    // Viewer
    GLKMatrix4 baseModelViewMatrix = GLKMatrix4MakeTranslation(0.0f, 0.0f, -3.5f);
    baseModelViewMatrix = GLKMatrix4Rotate(baseModelViewMatrix, _rotationViewer, 0.0f, 1.0f, 0.0f);
...
//    self.effect.transform.modelviewMatrix = modelViewMatrix;
    ...
    modelViewMatrix = GLKMatrix4MakeTranslation(0.0f, 0.0f, -2.0f);
    ...
    modelViewMatrixForNormal = GLKMatrix4Rotate(modelViewMatrixForNormal, 0, 0.0f, 1.0f, 0.0f);
    modelViewMatrixForNormal = GLKMatrix4Multiply(baseModelViewMatrix, modelViewMatrixForNormal);
    
    GLKMatrix4 modelViewMatrixIdentityTest = GLKMatrix4MakeTranslation(0.0f, 1.0f, 0.0f);
